...
Centralized privacy policy pages for Chrome extensions.
...
- Each policy is now a single root-level markdown file.
- Update the matching `privacy-policy-*.md` file before shipping any extension change that affects permissions or data flow.
